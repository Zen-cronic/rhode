...
const expected={optimizer:'roadstar-optimizer-00015-vuk',api:'roadstar-api-00036-woy',web:'roadstar-web-00062-sab',documents:'roadstar-documents-00021-tam'};
const services={};
...
const artifacts=[];
for(const [name,mediaType] of [['roadstar-demo.mp4','video/mp4'],['roadstar-demo.srt','application/x-subrip'],['roadstar-pitch.pdf','application/pdf'],['roadstar-pitch.pptx','application/vnd.openxmlformats-officedocument.presentationml.presentation']]){
