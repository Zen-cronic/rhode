...
const evidence={verifiedAt:new Date().toISOString(),currentSha256:currentHash,priorSha256:priorHash,packagedSha256:packagedHash,audioPacketSha256:currentAudio,captionsSha256:await hash(captions),probe,visualReplacement:{startSeconds:36,endSeconds:94,scenes:['Acknowledged dock wait with on-duty hold and provisional detention','Matched 3D baseline-versus-401-slowdown comparison at exact shared observations','Server-ranked recovery receipt','Bounded organizer-value scenario with added deadhead cost','Feasible and HOS-rejected candidate disclosure','Dispatcher approval gate'],sourceEvidence:['docs/evidence/3d-dock-2026-09-12/','docs/evidence/3d-slowdown-comparison-2026-09-12/','docs/evidence/public-dock-evidence-2026-09-12/','docs/evidence/ranked-recovery-2026-09-12/']},checks:['Public web asset and local submission package are byte-identical','Four-minute duration and H.264/AAC 1920x1080 24fps contract preserved','AAC packet stream is byte-identical to the previously accepted narration','Entire promoted film decodes without ffmpeg errors','Six recovery frames plus the return to the existing driver scene were inspected'],limits:'The replacement uses still frames from actual verified application states. The value frame models the organizer brief range as CAD and subtracts only the displayed variable deadhead cost; it is not measured revenue, savings or profit. Other film scenes and the accepted narration/caption timings are retained. Human listening and live presentation rehearsal remain operator checks; public video-host acceptance remains unconfirmed.'};
