...
try {
  ...
  const evidence = {
    ...
    revision: "roadstar-web-00070-rod",
    image:
      "us-central1-docker.pkg.dev/roadstar-2026-kzh/roadstar/web@sha256:ad996e02c2116d0e45b0e32bbb133234275e1826d5e4986b85e7ea7dbd61d77e",
    checks: [
