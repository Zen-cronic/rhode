...
try {
  ...
  const evidence = {
    ...
    revision: "roadstar-web-00068-jat",
    image:
      "us-central1-docker.pkg.dev/roadstar-2026-kzh/roadstar/web@sha256:0f39c210a45fde3b3746d9b6e32ce9568fc4c77422b352cdb2516877a89efe30",
    checks: [
