...
Evidence is in `docs/evidence/workflow-comparison-2026-09-12/verification.json`. Captures include the manual HOS failure, manual feasible proposal, and ranked decision receipt at desktop and narrow widths.
