...
The local independent simulator now consumes these receipts through freshly rechecked adoption evidence; see simulator-adoption.md. Native More receipt controls and offline evidence persistence are now verified on Android API35; see native-closure-reviews.md. No background push delivery, route adoption or cloud deployment is claimed by this packet.
