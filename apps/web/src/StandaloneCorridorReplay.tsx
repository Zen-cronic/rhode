...
export function StandaloneCorridorReplay(){
 ...
 return <main className="standalone-corridor-page">
  <header className="standalone-corridor-header"><a href="/" aria-label="RoadStar authenticated operations"><strong>RoadStar</strong><span>TRANSPORT / CONTROL</span></a><div><span className="tag">PUBLIC SYNTHETIC REPLAY</span><a href="/?view=dock-evidence">Dock evidence</a><a href="/">Open operations →</a></div></header>
