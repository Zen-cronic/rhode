...
export function StandaloneCorridorReplay(){
 ...
 return <main className="standalone-corridor-page">
  <header className="standalone-corridor-header"><a href="/" aria-label="RoadStar authenticated operations"><strong>RoadStar</strong><span>TRANSPORT / CONTROL</span></a><div><span className="tag">PUBLIC SYNTHETIC REPLAY</span><a href="/">Open authenticated operations →</a></div></header>
  ...
  <footer className="standalone-corridor-footer"><span>2 × 2,401 acknowledged synthetic observations</span><span>Read-only · no operational API access</span></footer>
 </main>;
}
